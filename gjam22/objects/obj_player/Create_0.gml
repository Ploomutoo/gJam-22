...
function minion_sort (_unit1, _unit2)
{
	var sort_type = real(_unit1.object_index) - real(_unit2.object_index);
	var sort_deployed = (_unit1.state != st.carry) -  (_unit2.state != st.carry);
	var sortId = real(_unit1) - real(_unit2);
